// This is Project 3 - Password Generator
...
export default function PasswordGenerator() {
  ...
  const generatePasswordString = (passwordLength: number) => {
    ...
    const generatedPass = createPassword(charactersList, passwordLength);
    ...
    <ScrollView keyboardShouldPersistTaps="handled">
      <SafeAreaView style={styles.appContainer}>
        <View style={styles.formContainer}>
          ...
          >
            {({ handleChange, handleSubmit, handleReset, handleBlur, values, touched, isValid, errors }) => (
              <>
                ...
                <View style={styles.inputWrapper}>
                  ...
                  <BouncyCheckbox disableBuiltInState={true}
                    isChecked={symbol}
